...
class _SystemThreadingThread_DynamicAssemblies
{
    static void Main()
    {
        Console.WriteLine("***** _ *****");
    ...
    static void SystemThreadingThread_Silent()
    {
        ...
        //   привычное System.AppDomain.CurrentDomain ****скопировано с метода DynamicAssembliesANDItsStuffANDCallingConvensions_Silent
