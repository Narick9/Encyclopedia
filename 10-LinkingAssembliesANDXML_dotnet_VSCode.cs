...
class LinkingAssembliesANDXML_dotnet_VSCode
{
    ...
    static void LinkingAssembliesANDXML_Silent()
    {
        ...
        //
        //
        //   Как оказалось, репозиторий Microsoft'а даже имеет место и для частных пакетов (а как же иначе, это Micro$oft). Если твоя компания
        //     не хочет делится своими наработками, она будет хранить свои NuGet пакеты в своей непубличной части https://www.nuget.org'а
        //
        //   В .NET Docs пишется не репозиторий NuGet, а "реестр" (register) NuGet
        //
        ...
        //
        //   Каждый NuGet пакет промаркирован одним или несколькими типами, что указывают на предозначение. Ввелось такое разделение не так
        //     давно (в NuGet версии 3.5, июнь 2016)
        //   
        //     Microsoft определила три основных типа:
        //   
        //           > Dependency  - пакеты, что добавляют обычную начинку в проекты. Это тип по умолчанию
        //           > DotnetTool  - пакеты, что являются .NET инструментами
        //                           /////////after reading: dotnet cli///////////////////////////////////////////////////////////
        //                           // , что ставятся в dotnet cli
        //                           /////////////////////////////////////////////////////////////////////////////////////////////
        //           > Template    - 
        //   
    ...
    static void dotnet_Silent()
    {
        ...
        // Для создания нового проекта (и не только) у утилиты dotnet есть подраздел new (подразделы в документациях зовутся commands,
        ...
        //       ****
        //       
        //       /////////after reading: webapi///////////////////////////////////////////////////////////////
        //       // О дополнительных аргументах к web, webapp, webapi написано в методе об ASP.NET Core
        //       /////////////////////////////////////////////////////////////////////////////////////////////
        //       
        //       
        //                                                  
    ...
    static void VSCode_Silent()
    {
        ...
        /////////after reading:IntelliSenseANDCodeLens_..()//////////////////////////////////////////
        // Странно, но VS Code'овский IntelliSense при обозревании внутренного проекта (т.е. проекта
        //   , корневая директория которого лежит в директории другого проекта), не видит связанные
        //   с этим проектом сборки (и поэтому обводит все внешние типы в коде этого проекта
        //   красной волной)
        /////////////////////////////////////////////////////////////////////////////////////////////
