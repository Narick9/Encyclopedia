...
class ManifestANDGACANDAttributesForAssembly
{
    ...
    static void ManifestANDGACANDAttributesForAssembly_Silent()
    {
        ...
        //   , но повтарюсь. Манифест содержит такие вещи, как версия этой сборки, сведения о культуре (для того, чтобы CLR использовала нужные
        ...
        //   обычно ещё несколько малозначительных вещей)
        //
