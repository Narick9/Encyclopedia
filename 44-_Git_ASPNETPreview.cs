...
class _Git_ASPNETPreview
{
    ...
    static void Git_Silent()
    {
        ...
        //         
        //     Как уже говорилось, git репозиторий может хранить в себе несколько веток разработки. Работать с ветками можно как раз
        //         средствами этого раздела. Синопсис раздела прост:
        //         
        ...
        //             * master
        //         
        //         Как видишь, звёздочкой помечена текущая ветка
        //         
        ...
        //         изменены, но таки неза'commit'чены в предыдущей ветке. У меня такой выхлоп выглядит так:
        //         
