...
class _Git_ASPNETPreview
{
    ...
    static void Git_Silent()
    {
        ...
        //     
        //     
        //   Вот что Линус Торвальдс сам говорит о git'е:
        //     
        ...
        //         
        //     Этот подраздел сделан для сохранения временных снимков в репозиторий. Сделай это, как только ты решишь, что твой временный
        //       снимок готов к увековечиванию.
        //         
        ...
        //
        //         
        //     Выполнив команду    git commit    , тебе откроется prompt с текущим снимком (prompt откроется в редакторе, что назначен в
        //         $GIT_EDITOR. если такая переменная не назначена, откроется в редакторе, что назначен в $EDITOR). В этом prompt'е тебе ты
        //         можешь оставить сообщение об это commit'е. Там уже будет достаточно написаны детальные логи о том, что будет добавлено или
        //         изменено, но все эти строчки закоментированны. Закоментированные строчки будут пропущенны, так что ты сам решаешь, что
        //         добавить в сообщение. Составив сообщение, ты его сохраняешь, и этим совершаешь commit
        //         
        //         
        //   git diff
        //         
        //     Перед тем, как за'commit'ить снимок, ты можешь захотеть посмотреть на то, что в нём чейчас находится
        //         
        //         
        //         
        //         
