...
class _Git_ASPNETPreview
{
    ...
    static void Git_Silent()
    {
        ...
        //           
        //       Как выглядит index (он же temporary staging area)? Добавленные через git add файлы хранятся в папке
        ...
        //   git clean
        //           
        //       Удаляет файлы в директории проекта, что не включены в репозиторий
        //           
        //           
