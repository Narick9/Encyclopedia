...
class _Git_ASPNETPreview
{
    ...
    static void Git_Silent()
    {
        ...
        //       Есть такая утилита, git-format-patch. Её суть в том, что она упаковывает commit в email. Первые строчки она использует в
        //           качестве загаловка к email-сообщению, а весь последующий текст помещает в тело
        //           
        ...
        //           
        //           Простой ввод git diff отправит тебя в read-only prompt, где будут описаны отличия текущего снимка от прошлого commit'а
        ...
        //           
        //           Вводи эту команди, находясь в проекте со своим репозиторием, и они будут привносить в этот твой репозиторий запрошенные
        //           вещи
        //           
        ...
        //           
        //               git pull [options] [<dirWithRepo>] [<branch>]
        //           
