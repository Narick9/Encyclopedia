...
class _Git_ASPNETPreview
{
    ...
    static void ASPNETPreview_Silent()
    {
        ...
        //   
        //   ASP.NET MVC появился вместе с ASP.NET Web Pages (последний вышел чуть позже, в 2010-ом). В ASP.NET Web Pages где страницы (также,
        //       как и в Web Forms строились на C#'пе ****как я понял). Microsoft'цы сделали ставку именно на фреймворк Web Pages, переделав
        //       ASP.NET под него
        //
        //   В самом начале назревания cross-platform революции (2016 год) Micro$oft'цы, в паре с .NET Core 1.0, выпустили ASP.NET Core 1.0
        ...
        //
        //   До cross-platform революции ASP.NET звался ASP.NET 4.x (да и вообще тогда весь .NET Framework был версии 4.x), после его
        ...
        //   
        //   Работает с Windows, macOS, or Linux            Работает с Windows
        //   
        ...
        //         как приложение начнёт генерировать контент (Web Pages же здесь явно выигрывает, ведь с ним простенькие проекты строятся
        //         всего за пару часов)
        //         
        ...
        // SPA
        //         
        //     Single-page applications (SPAs) - по этой технологии браузер делает один HTTP запрос и получает один HTML файл, включающий в себя
        //         целый (обычно) JavaSript клинт (например, Angular или React)
        //       
        ...
        //       как для сервера, так и для самого пользователя (резульутат у него будет мгновенный)
        //       
        ...
        //                                             функционалости сайта) и конвеер запросов приложения (****слабо понятно)
        ...
        //           └───────────────────────────────────────────────────────────────────────────┘
        //       
        //       Почему фреймворком приложения несколько? Просто они решают разные проблемы (на самом деле иногда решают одну проблему. в таком
        //       случае ты сам решаешь каким пользоваться)
