...
class _Git_ASPNETPreview
{
    ...
    static void Git_Silent()
    {
        ...
        //         в temporary staging area, что зовётся "index". Ты можешь постоянно добавлять в этот снимок всё больше новых файлов, вводя
        //             git add <..>
        ...
        //         
        //         
        //         ****здесь должен быть начало с синопсисом. строка ниже - продолжение
        //         Выполнить    git commit    не удастся, если ты ещё не представился git'у через git config
        //         
        //         
        //         
        //         
