...
class _Git_ASPNETPreview
{
    ...
    static void Git_Silent()
    {
        ...
        //   git checkout
        //           
        //       Переключиться между разными версиями одного и того же объекта. Как правило, этот раздел используют для сравнения
        //           за'fetch'енной ветки с локальной
        //           
        //       Раздел git checkout работает только с 3-емя объектами - файлами, commit'ами и branch'ами
        //           
