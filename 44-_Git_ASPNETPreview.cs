...
class _Git_ASPNETPreview
{
    ...
    static void Git_Silent()
    {
        ...
        //         
        //     На данный момент мы имеет две ветки, и начинка в них различается. Влить в текущую ветку master наработки ветки experimental, нам
        //         следует воспользоваться разделом    git merge    . Синопсис прост:
        //         
        ...
        //         
        //     Раздел git branch имеет такие [opptions]:
        ...
        //         чей-то репозиторий себе на машину (в нужное место). Синопсис прост:
        //         
        //             git clone [options] <dirWithRepo> <targetDir>
        //         
        ...
        //         
        //     Если кто-то за'clone'ил и модифицировал твой проект, и ты хочешь внести эти модификации, тебе как раз следует воспользоваться
        //         этим
        //         
        //     В разделе git pull ты найдёшь нубор инструментов для получения и интегрирования чужих репозиториев (или местных веток).
        //         Синопсис, конечно, не сложен:
        //         
        ...
        //         
        //         
        //@1@@ты добавить инфо в часть про git merge
        //@2@@ты сделать часть про git clone
        //@3@@ты начать часть про git pull. очень хочешь продолжить
