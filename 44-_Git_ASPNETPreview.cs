...
class _Git_ASPNETPreview
{
    ...
    static void ASPNETPreview_Silent()
    {
        ...
        //  
        //   Изначально был ASP.NET Web Forms, где разработчики писали код и скрипты, чтоб затем этот движок перевёл C#-код в HTML
        ...
        //     видит все изменения у себя на экране (инфу о модели, скидку, ...) - эта часть зовётся View
        //
        //   Ну т.е. понимаешь, да?
        //
        ...
        //     построения web-сервиса (иначе говоря, web-службы или web API). REST запросы (т.е. команды) строятся на HTTP, т.е. они
        ...
        //     
        //   По шаблону webapp создадутся 2 основных .cs файла. Один из них, Startup.cs, содержит класс Startup, что конфигурирует сервисы и
        //       конвеер запросов приложения (****что это?)(комментарии в нашем ./SimpleWebApp_ASP.NET/Startup.cs присутствуют)
        //     
