...
namespace SimpleWeb_ASP.NET
{
    public class Program
    {
        public static void Main(string[] args)
        {
                                                    ...
                                                    //   приложение)(больше информации об этом типе ты сможешь найти в методе о ..IHost)
            ...
            Host.CreateDefaultBuilder(args)
                ...
                {                                        
                    webBuilder.UseStartup<Startup>();
                                                         ...
                                                         //   поставляется расширением из ****откуда?) конфигурирует его, делая из обычного
                                                         //   .NET хоста настоящее ASP.NET Core приложение. Вот что именно
                                                         //   произойдёт:
